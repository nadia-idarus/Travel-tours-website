...
<head>
    ...
    <title>Olsera Admin Dashboard</title>
...
<div class="container-fluid">
  <div class="row">
      ...
      <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
          ...
          <p>Welcome to olsera sopa travel and tours we value your feedback highly</p>
      </main>
      <div class="row my-4">
  <div class="col-12 col-md-6 col-lg-3 mb-4 mb-lg-0">
      <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Feb 1 - Apr 1, Tsavo</p>
  ...
  <div class="col-12 col-md-6 mb-4 mb-lg-0 col-lg-3">
      <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Feb 1 - Apr 1, Diani</p>
  ...
  <div class="col-12 col-md-6 mb-4 mb-lg-0 col-lg-3">
      <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Feb 1 - Apr 1, Zanzibar</p>
  ...
  <div class="col-12 col-md-6 mb-4 mb-lg-0 col-lg-3">
      <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Feb 1 - Apr 1, Watamu</p>
                  ...
                  <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>nadia.idarus@company.com</td>
                          <td>$153.11</td>
                          <td>Aug 28 2020</td>
                          <td><a href="#" class="btn btn-sm btn-primary">View</a></td>
                        </tr>
